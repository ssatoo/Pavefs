...
public func LocalizedResetLanguage()
{
    ...
    lang.setLocale(SLocalize.supportedLocales[1])
}
...
class SLocalize
{
    ...
    static let Instance: SLocalize = SLocalize(locale: "el")
    ...
    private func initGeneralLocalizations()
    {
        ...
        englishStrings["RateQuestion"] = "How would you rate this response?"
        englishStrings["RateSubmit"] = "Submit review"
        
        
        
        englishStrings["spinner_review"] = "Review"
        englishStrings["spinner_review_fail"] = "Totally unsuccessful"
        englishStrings["spinner_review_success"] = "Somehow/Totally successful"
        englishStrings["progress_submitting_review"] = "Submitting review"
        englishStrings["successful_review_submission"] = "Thank you for your review"
        englishStrings["unsuccessful_review_submission"] = "Reviewing unsucessful, please try again"
        
        
        //---- EL Localized Strings
        greekStrings["RateSubmit"] = "Καταχώριση αξιολόγησης"
        greekStrings["RateQuestion"] = "Πώς κρίνετε την παρέμβαση;"
        
        greekStrings["spinner_review"] = "Αξιολόγηση"
        greekStrings["spinner_review_fail"] = "Απολυτως αποτυχημενη"
        greekStrings["spinner_review_success"] = "Μερικως/Απολυτως Επιτυχημενη"
        greekStrings["progress_submitting_review"] = "Καταχώριση Αξιολόγησης.."
        greekStrings["successful_review_submission"] = "Eυχαριστούμε για την αξιολόγηση"
        greekStrings["unsuccessful_review_submission"] = "Αξιολογηση ανεπιτυχης, παρακαλω προσπαθηστε ξανα"
        
        greekStrings["cancel"] = "Άκυρο"
